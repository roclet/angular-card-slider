...
export class CarouselComponent {
  ...
  // initCarousel(): void {
  //   console.log(this.carousel.nativeElement, 'xxxxxx', this.carousel);
  //   if (this.carousel && this.carousel.nativeElement) {
  //     console.log(this.carousel.nativeElement.children, 'xxxxxx', this.carousel);
  ...
  //     console.log(this.carousel.nativeElement.childNodes.length, 'xxxxxx', this.middleIndex);
  //     const midElement = this.carousel.nativeElement.children[this.middleIndex - 1];
  //     console.log('pppppppppppppppppppppppp', midElement);
  //     gsap.to(midElement, {
  //       duration: 0,
